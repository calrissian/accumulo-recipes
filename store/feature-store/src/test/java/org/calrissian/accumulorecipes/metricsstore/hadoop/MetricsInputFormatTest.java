...
public class MetricsInputFormatTest {
    ...
    public static class TestMapper extends Mapper<Key, FeatureWritable, Text, Text> {
        ...
        @Override
        protected void map(Key key, FeatureWritable value, Context context) throws IOException, InterruptedException {
            metric = value.get();
        }
    }
}
