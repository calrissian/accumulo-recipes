...
public class PrefixedColumnQualifierIterator implements SortedKeyValueIterator<Key, Value> {
    ...
    public PrefixedColumnQualifierIterator() {

    }

    PrefixedColumnQualifierIterator(SortedKeyValueIterator<Key,Value> source) {
    ...
    public SortedKeyValueIterator<Key, Value> deepCopy(IteratorEnvironment env) {
        if (sourceIter != null)
            return new PrefixedColumnQualifierIterator(sourceIter.deepCopy(env));
        return new PrefixedColumnQualifierIterator();
    }
