...
public class MetricsLoaderTest {
    ...
    public void testGetNext() throws AccumuloException, TableExistsException, TableNotFoundException, AccumuloSecurityException, IOException, InterruptedException, TypeEncodingException, URISyntaxException {
        ...
        List<Pair<String, MetricWritable>> mocks = new ArrayList<Pair<String, MetricWritable>>();
        mocks.add(new Pair<String, MetricWritable>("", new MetricWritable(metric)));

        MockRecordReader<String, MetricWritable> mockRecordReader = new MockRecordReader<String, MetricWritable>(mocks);
