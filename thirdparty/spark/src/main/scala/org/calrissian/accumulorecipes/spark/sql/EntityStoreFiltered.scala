 ...
 * )
 */
class EntityStoreFiltered extends RelationProvider {

  override def createRelation(sqlContext: SQLContext, parameters: Map[String, String]): BaseRelation = {
    EntityStoreFilteredScan(parameters("inst"), parameters("zk"), parameters("user"), parameters("pass"),
      parameters("type"), sqlContext)
  }
}

case class EntityStoreFilteredScan(inst: String, zk: String, user: String, pass: String,
                           entityType: String,
                           @transient val innerSqlContext: SQLContext) extends QfdFilteredScan(inst, zk, user, pass, entityType, innerSqlContext) {
